  ...
  onStart: async function ({ event, api, args }) {
    ...
    switch (command) {
      ...
      case "del":
        ...
        api.sendMessage(`âš™ï¸ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—®ð—¹ ð—¦ð˜†ð˜€ð˜ð—²ð—º\nâ”â”â”â”â”â”â”â”â”â”\n\nGroup has been removed from the approval list. \nðŸ | Group: ${groupNameDel}\nðŸ†” | TID: ${idToApprove}`, threadID, messageID);
        break;

      case "batch":
        const idsToApprove = args.slice(1);
        let batchMessage = "âš™ï¸ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—®ð—¹ ð—¦ð˜†ð˜€ð˜ð—²ð—º\nâ”â”â”â”â”â”â”â”â”â”\n\nApproved Groups:\n";
        for (const id of idsToApprove) {
          if (isNumeric(id) && !approvedData.includes(id)) {
            ...
            batchMessage += `ðŸ | Group: ${groupNameBatch}\nðŸ†” | TID: ${id}\n`;
          }
        }
        fs.writeFileSync(approvedDataPath, JSON.stringify(approvedData, null, 2));
      ...
      case "search":
        ...
        let searchMsg = `âš™ï¸ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—®ð—¹ ð—¦ð˜†ð˜€ð˜ð—²ð—º\nâ”â”â”â”â”â”â”â”â”â”\n\nSearch Results for "${searchTerm}":\n`;
        for (let index = 0; index < approvedData.length; index++) {
          const groupId = approvedData[index];
      ...
      default:
        if (!isNumeric(idToApprove)) {
          ...
          api.sendMessage(`âš™ï¸ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—®ð—¹ ð—¦ð˜†ð˜€ð˜ð—²ð—º\nâ”â”â”â”â”â”â”â”â”â”\n\nðŸ Group: ${groupName} | TID: ${idToApprove} was already approved!`, threadID, messageID);
        } else {
          // Approve the group
          ...
          const approvalMessage = `âš™ï¸ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—®ð—¹ ð—¦ð˜†ð˜€ð˜ð—²ð—º\nâ”â”â”â”â”â”â”â”â”â”\n\nYour group has been approved by ${userName}\nðŸ”Ž ð—”ð—°ð˜ð—¶ð—¼ð—» ð—œð—— ${userID}\nðŸ–‡ ð—™ð—• ð—Ÿð—¶ð—»ð—¸: ${userFbLink}\nðŸ—“ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—²ð—§ð—¶ð—ºð—²: ${approvalTime}/${approvalDate}\n\nâ„¹ ð—”ð—½ð—½ð—¿ð—¼ð˜ƒð—²ð—± ð——ð—®ð˜ð—®: ${approvalCount}\n${customMessage}`;
